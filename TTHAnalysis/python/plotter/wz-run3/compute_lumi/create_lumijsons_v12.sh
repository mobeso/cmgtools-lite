...
python3 buildJSONfromNano.py --datasets Muon --inpath $inpath/2022PostEE --filterjson $golden --filter-by-era Run2022F --filter-by-version v1
...
python3 buildJSONfromNano.py --datasets EGamma --inpath $inpath/2022PostEE --filterjson $golden --filter-by-era Run2022G --filter-by-version v1
